...
- **Cards / Grid**: Sections shown as clickable cards with flip animation. Click a card to open the section. Best for visual courses with images.
- **Tabs**: Sections shown as horizontal tabs. Switch between sections by clicking tabs. Best for courses with fewer sections.
- **Modern List**: Sections shown as a vertical list with progress bars and links. Clean and minimal.
- **Timeline**: Sections shown on a vertical timeline with dots and content. Good for sequential/chronological courses.
- **Learning Path**: Sections shown as a zigzag learning path with milestone nodes. Shows progress status per step (completed, in progress, pending). Great for guided, sequential courses.
- **Kanban Board**: Sections automatically sorted into 3 columns (Pending, In Progress, Completed) based on student progress. Great for task/project-based courses.
- **Metro Tiles**: Windows-inspired live tiles of varying sizes in a dynamic grid. Bold colours, hover animations, and a modern dashboard feel.
